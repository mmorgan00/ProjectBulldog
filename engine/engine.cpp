...
* @detail Calls original create_image, but also allocates a staging buffer and performs the upload operation
*/
...
void GLTFMetallic_Roughness::build_pipelines(VulkanEngine* engine)
{
	...
	if (!vkutil::load_shader_module("../../shaders/mesh.frag.glsl.spv", engine->_device, &meshFragShader)) {
		fmt::println("Error when building the triangle fragment shader module");
	}

	VkShaderModule meshVertexShader;
	if (!vkutil::load_shader_module("../../shaders/mesh.vert.glsl.spv", engine->_device, &meshVertexShader)) {
